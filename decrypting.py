...
class Decryptor:
    ...
    def __init__(self, settings: dict):
        ...
        Parameters
        ----------
            settings: dict словарь, хранящий пути к файлам, нужные для работы шифровщика.
        Attributes:
        ----------
            self.__ways: dict хранит пути к файлам, нужные для работы шифровщика.
            self.__key хранит симметричный ключ шифрования.
            self.__iv хранит значение вектора инициализации для шифрования.
            self.__text_to_decrypt хранит текст, который нужно дешифровать.
        """
